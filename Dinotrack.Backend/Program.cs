...
using Dinotrack.Backend.Repositories;
using Dinotrack.Backend.Services;
using Dinotrack.Backend.UnitsOfWork;
...
builder.Services.AddDbContext<DataContext>(c => c.UseSqlServer("name=LocalConnection"));
