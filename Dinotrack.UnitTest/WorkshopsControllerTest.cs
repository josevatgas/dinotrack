...
namespace Dinotrack.UnitTest
{
    ...
    public class WorkshopsControllerTest
    {
        ...
        private readonly Mock<IGenericUnitOfWork<Workshop>> _unitOfWorkMock;

        public WorkshopsControllerTest()
        {
            _options = new DbContextOptionsBuilder<DataContext>()
                .UseInMemoryDatabase(Guid.NewGuid().ToString())
                .Options;
            _unitOfWorkMock = new Mock<IGenericUnitOfWork<Workshop>>();
        }
        ...
        public async Task GetAsync_ReturnsOkResult()
        {
            ...
            var controller = new WorkshopsController(_unitOfWorkMock.Object, context);
